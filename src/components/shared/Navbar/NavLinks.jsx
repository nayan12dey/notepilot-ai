        ...
        return (
          <li key={link.href} className="list-none">
            <Link
              href={link.href}
              onClick={onItemClick}
              className={`relative flex items-center justify-center px-4 py-2 text-sm font-medium rounded-full transition-all duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 ${
                isActive
