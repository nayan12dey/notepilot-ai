...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col justify-center items-center bg-slate-950 px-4 py-12 md:py-20 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 left-1/4 w-[350px] h-[250px] bg-purple-500/10 blur-[120px] rounded-full pointer-events-none -z-10" />
      ...
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl p-8 rounded-3xl border border-slate-800/80 shadow-2xl shadow-slate-950/80 space-y-6">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-10 pr-4 py-3 rounded-xl border bg-slate-950/80 text-slate-100 placeholder-slate-500 text-sm font-medium transition-all focus:outline-none ${errors.name
            ...
            {errors.name && (
              <p className="text-[11px] font-bold text-rose-400 pl-1">{errors.name.message}</p>
            )}
          </div>
        ...
        <p className="text-center text-xs text-slate-400 font-medium pt-2">
          ...
          <a href="/login" className="font-bold text-cyan-400 hover:underline hover:text-cyan-300 transition-colors">
            Sign In
          </a>
        </p>
      </div>
